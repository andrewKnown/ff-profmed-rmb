      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 md:gap-8 lg:gap-12">
          ...
          <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-medical-card hover:shadow-lg transition-all">
            ...
            <h3 className="font-semibold mb-2 text-primary text-xl">4.8/5 Rating</h3>
            <p className="text-medical-text/70">Consistently excellent service satisfaction</p>
          </div>
        ...
        <div className="mt-12 text-center">
          ...
          <div className="flex justify-center">
            <Button 
              ...
              size="lg" 
              className="bg-primary hover:bg-primary/90 text-white font-medium py-6 px-8"
            >
